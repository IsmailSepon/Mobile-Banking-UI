...
public class ContactablesLoaderCallbacks implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int loaderIndex, Bundle args) {
        ...
        Toast.makeText(mContext, "onCreateLoader", Toast.LENGTH_LONG).show();
...
//        }
        ...
        Toast.makeText(mContext, "onLoadFinished", Toast.LENGTH_LONG).show();

        // Reset text in case of a previous query
        //tv.setText(mContext.getText("hello") + "\n\n");
        ...
        do {
            ...
            if (mimeType.equals(CommonDataKinds.Phone.CONTENT_ITEM_TYPE)) {
              //  tv.append("\tPhone Number: " + cursor.getString(phoneColumnIndex) + "\n");
                ...
                Log.e("Contact", cursor.getString(phoneColumnIndex) + "\n");
            } else if (mimeType.equals(CommonDataKinds.Email.CONTENT_ITEM_TYPE)) {
              //  tv.append("\tEmail Address: " + cursor.getString(emailColumnIndex) + "\n");

                Log.e("Contact", cursor.getString(emailColumnIndex) + "\n");
