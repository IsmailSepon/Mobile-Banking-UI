package com.cloudwell.paywell.uiCommon.pay.fragment.recurringBillPay.tooltip;
...
public class Tooltip {
    ...
    public void TooltipWindow(Context ctx) {
        this.ctx = ctx;
        tipWindow = new PopupWindow(ctx);

        inflater = (LayoutInflater) ctx.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        contentView = inflater.inflate(R.layout.recur_tooltip_layout, null);
    }

   public void showToolTip(View anchor) {

        tipWindow.setHeight(WindowManager.LayoutParams.WRAP_CONTENT);
        tipWindow.setWidth(WindowManager.LayoutParams.WRAP_CONTENT);
