...
import com.cloudwell.paywell.ui.ticket.airticket.airportSearch.model.Airline
import com.cloudwell.paywell.ui.ticket.airticket.airportSearch.model.Fare
...
object CalculationHelper {
    ...
    fun getFare(fares: com.cloudwell.paywell.ui.ticket.airticket.flightDetails1.model.Fare, airlineCode: String): com.cloudwell.paywell.ui.ticket.airticket.flightDetails1.model.Fare {
        val readData = InternalStorageHelper.readData(InternalStorageHelper.CombustionfileName)
        val commission = Gson().fromJson(readData, Commission::class.java)
        val retailerCommission = commission.retailerCommission
        val total_commission = commission.totalCommission
...
//        isLocalAirless = checkIsLocalAirlines(airlineCode, isLocalAirless)
    ...
    fun getTotalFareDetati(fares: MutableList<com.cloudwell.paywell.ui.ticket.airticket.flightDetails1.model.Fare>, airlineCode: String): String {
        val readData = InternalStorageHelper.readData(InternalStorageHelper.CombustionfileName)
        val commission = Gson().fromJson(readData, Commission::class.java)
        val retailerCommission = commission.retailerCommission
        val total_commission = commission.totalCommission
...
//        isLocalAirless = checkIsLocalAirlines(airlineCode, isLocalAirless)
    ...
    fun retailerEarning(fare: MutableList<com.cloudwell.paywell.ui.ticket.airticket.flightDetails1.model.Fare>): String? {
