...
public class ApiUtils {
    ...
    private static final String TEST = "https://api.themoviedb.org/3/";
    ...
    public static APIService testclient() {
        return RetrofitClient.INSTANCE.getConsumerClient(TEST).create(APIService.class);
      //  return NetClient.INSTANCE.getClient(CONSUMER).create(APIService.class);
    }
