...
class BusinessAccountDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root: View = inflater.inflate(R.layout.bu_ac_details_fragment, container, false)
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(sectionNumber: Int): BusinessAccountDetailsFragment {
            return BusinessAccountDetailsFragment().apply {
