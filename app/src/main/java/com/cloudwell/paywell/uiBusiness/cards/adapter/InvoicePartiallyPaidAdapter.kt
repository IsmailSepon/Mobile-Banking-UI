...
class InvoicePartiallyPaidAdapter(mContext: Context, courselist: List<IssuedPOjo>) :
    RecyclerView.Adapter<InvoicePartiallyPaidAdapter.ViewHolder?>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.invoice_partiallypaid_item, parent, false)
