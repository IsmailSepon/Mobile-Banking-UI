...
class PartiallyPaidIRecyclerAdapter(mContext: Context, courselist: List<PaidExpencePOjo>) :
    RecyclerView.Adapter<PartiallyPaidIRecyclerAdapter.ViewHolder?>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.rapidlly_paid_ex_item, parent, false)
