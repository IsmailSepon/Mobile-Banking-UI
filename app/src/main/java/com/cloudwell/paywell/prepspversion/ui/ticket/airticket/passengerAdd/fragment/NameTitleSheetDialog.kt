package com.cloudwell.paywell.prepspversion.ui.ticket.airticket.passengerAdd.fragment
...
import com.cloudwell.paywell.prepspversion.ui.ticket.airticket.passengerAdd.model.Gender
...
class NameTitleSheetDialog : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val className: String? = requireArguments().getString("title")
        val view = inflater.inflate(R.layout.class_item_list_dialog, container, false)
        view.tvCatagory.text = getString(R.string.title)
