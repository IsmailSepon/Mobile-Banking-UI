...
import com.cloudwell.paywell.ui.BusinessUI.control.fragment.personal_profile.PersonalProfile
import com.cloudwell.paywell.ui.BusinessUI.control.fragment.personal_profile.PersonalProfileSettinggsFrg
 ...
 */
class BuCtrlProfilePagerAdapter(private val context: Context, fm: FragmentManager) :
    FragmentPagerAdapter(fm) {

    override fun getItem(position: Int): Fragment {
        return when (position) {
            0 -> PersonalProfile.newInstance(0)
