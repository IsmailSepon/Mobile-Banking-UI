...
class CashWithDreawMainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.cash_withdraw_main_layout, container, false)
        ...
        view.cashwithdraw_btn.setOnClickListener(View.OnClickListener {

            FragmentHelper.replaceFragment(
                CashWithDrawProcessFragment(),
