...
import kotlinx.android.synthetic.main.statment_excel_layout.view.*
...
class StatmentExcelragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.statment_excel_layout, container, false)



        view.share_statment.setOnClickListener(View.OnClickListener {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(sectionNumber: Int): StatmentExcelragment {
            return StatmentExcelragment().apply {
